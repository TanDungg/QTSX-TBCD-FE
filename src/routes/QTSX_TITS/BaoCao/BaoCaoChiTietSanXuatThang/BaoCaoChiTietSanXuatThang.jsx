...
function BaoCaoChiTietSanXuatThang({ match, history, permission }) {
  ...
  const getListData = (tits_qtsx_SanPham_Id, thangNam) => {
    ...
    new Promise((resolve, reject) => {
      dispatch(
        fetchStart(
          `tits_qtsx_BaoCao/bao-cao-san-xuat-thang?${param}`,
          "GET",
          null,
          "LIST",
          "",
  ...
  const handleXuatExcel = () => {
    new Promise((resolve, reject) => {
      dispatch(
        fetchStart(
          `tits_qtsx_BaoCao/export-file-bao-cao-san-xuat-thang`,
          "POST",
          {
            nam: ThangNam.slice(3),
            thang: ThangNam.slice(0, 2),
      ...
      exportExcel("BaoCaoSanXuatThang", res.data.dataexcel);
    });
  };
...
export default BaoCaoChiTietSanXuatThang;
