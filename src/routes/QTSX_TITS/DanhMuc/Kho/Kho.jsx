...
function Kho({ match, history, permission }) {
  ...
  const loadData = (keyword, page) => {
    ...
    dispatch(
      fetchStart(
        `tits_qtsx_CauTrucKho/cau-truc-kho-by-thu-tu?${param}`,
        "GET",
        null,
        "LIST"
      )
  ...
  let dataList = reDataForTable(data, page, pageSize);
  /**
   * Tìm kiếm người dùng
   *
   */
