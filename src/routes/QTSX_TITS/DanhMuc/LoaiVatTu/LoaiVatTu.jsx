...
function LoaiVatTu({ match, permission, history }) {
  ...
  const getListData = (keyword, page) => {
    ...
    dispatch(fetchStart(`tits_qtsx_LoaiVatTu?${param}`, "GET", null, "LIST"));
  };
  ...
  const deleteItemAction = (item) => {
    let url = `tits_qtsx_LoaiVatTu/${item.id}`;
  ...
  let colValues = [
    ...
    },
    {
      ...
      onFilter: (value, record) => record.maLoaiVatTu.includes(value),
      filterSearch: true,
    },
    {
