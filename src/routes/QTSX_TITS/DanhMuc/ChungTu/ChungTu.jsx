...
function ChungTu({ match, permission, history }) {
  ...
  let colValues = [
    ...
    },
    {
      ...
      onFilter: (value, record) => record.maSoChungTu.includes(value),
      filterSearch: true,
    },
    {
      title: "Tên số chừng từ",
      dataIndex: "tenSoChungTu",
      key: "tenSoChungTu",
      align: "center",
      filters: removeDuplicates(
        map(dataList, (d) => {
          return {
            text: d.tenSoChungTu,
            value: d.tenSoChungTu,
          };
        })
      ),
      onFilter: (value, record) => record.tenSoChungTu.includes(value),
      filterSearch: true,
    },
    {
      title: "Kho",
      ...
      onFilter: (value, record) => record.tenCTKho.includes(value),
      filterSearch: true,
    },
    {
      title: "Chức năng",
