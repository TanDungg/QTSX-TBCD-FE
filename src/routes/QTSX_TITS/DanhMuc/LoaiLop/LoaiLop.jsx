...
import ImportLoaiLop from "./ImportLoaiLop";

const { EditableRow, EditableCell } = EditableTableRow;
function LoaiLop({ match, permission, history }) {
  ...
  const getListData = (keyword, page) => {
    ...
    dispatch(fetchStart(`tits_qtsx_LoaiLop?${param}`, "GET", null, "LIST"));
  };
  ...
  const deleteItemAction = (item) => {
    let url = `tits_qtsx_LoaiLop/${item.id}`;
  ...
  let colValues = [
    ...
    },
    {
      ...
      onFilter: (value, record) => record.tenLoaiLop.includes(value),
      filterSearch: true,
    },
    {
      title: "Ghi chú",
  ...
  return (
    <div className="gx-main-content">
      <ContainerHeader
        title={"Loại lốp"}
        description="Danh sách loại lốp"
