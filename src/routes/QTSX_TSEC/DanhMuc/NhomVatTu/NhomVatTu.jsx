...
function NhomVatTu({ history, permission, match }) {
  ...
  const deleteItemFunc = (item) => {
    const title = "nhóm vật tư";
    ModalDeleteConfirm(deleteItemAction, item, item.tenNhomVatTu, title);
  };

  const deleteItemAction = (item) => {
    let url = `tsec_qtsx_NhomVatTu/${item.id}`;
    new Promise((resolve, reject) => {
  ...
  let colValues = [
    ...
    },
    {
      ...
      onFilter: (value, record) =>
        record.maNhomVatTu && record.maNhomVatTu.includes(value),
      filterSearch: true,
    },
    {
