...
function DonViDaoTao({ history, permission, match }) {
  ...
  const deleteItemFunc = (item) => {
    const title = "đơn vị đào tạo";
    ModalDeleteConfirm(deleteItemAction, item, item.tenDonViDaoTao, title);
  };

  const deleteItemAction = (item) => {
    let url = `vptq_lms_DonViDaoTao/${item.id}`;
    new Promise((resolve, reject) => {
  ...
  let colValues = [
    ...
    },
    {
      ...
      filters: removeDuplicates(
        map(dataList, (d) => {
          return {
            text: d.maDonViDaoTao,
            value: d.maDonViDaoTao,
          };
        })
      ),
      onFilter: (value, record) => record.maDonViDaoTao.includes(value),
      filterSearch: true,
    },
    {
      title: "Tên đơn vị đào tạo",
  ...
  return (
    <div className="gx-main-content">
      <ContainerHeader
        title={"Danh mục đơn vị đào tạo"}
        description="Danh sách đơn vị đào tạo"
