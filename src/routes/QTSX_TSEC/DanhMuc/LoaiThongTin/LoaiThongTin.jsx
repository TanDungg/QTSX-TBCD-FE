...
function LoaiThongTin({ history, permission, match }) {
  ...
  const deleteItemFunc = (item) => {
    const title = "loại thông tin";
    ModalDeleteConfirm(deleteItemAction, item, item.tenLoaiThongTin, title);
  };

  const deleteItemAction = (item) => {
    let url = `tsec_qtsx_LoaiThongTin/${item.id}`;
    new Promise((resolve, reject) => {
  ...
  return (
    <div className="gx-main-content">
      <ContainerHeader
        title={"Danh mục loại thông tin"}
        description="Danh sách loại thông tin"
