...
function BaoCaoKetQuaDaoTaoTheoThang({ history, permission }) {
  ...
  const getListData = (thangnam) => {
    ...
    new Promise((resolve, reject) => {
      dispatch(
        fetchStart(
          `vptq_lms_BaoCao/bao-cao-ket-qua-dao-tao-theo-thang?${param}`,
          "GET",
          null,
          "LIST",
          "",
  ...
  const handleXuatExcel = () => {
    ...
    new Promise((resolve, reject) => {
      dispatch(
        fetchStart(
          `vptq_lms_BaoCao/export-bao-cao-ket-qua-dao-tao-theo-thang`,
          "POST",
          DataXuatExcel,
          "",
          "",
  ...
  return (
    <div className="gx-main-content">
      <ContainerHeader
        title="Báo cáo kết quả đào tạo theo tháng"
        description="Báo cáo kết quả đào tạo theo tháng"
...
export default BaoCaoKetQuaDaoTaoTheoThang;
