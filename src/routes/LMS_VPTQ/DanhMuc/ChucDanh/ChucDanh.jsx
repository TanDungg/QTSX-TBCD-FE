...
function ChucDanh({ history, permission, match }) {
  ...
  const deleteItemAction = (item) => {
    let url = `vptq_lms_ChucDanh/${item.id}`;
    new Promise((resolve, reject) => {
  ...
  let colValues = [
    ...
    },
    {
      ...
      onFilter: (value, record) => record.maChucDanh.includes(value),
      filterSearch: true,
    },
    {
      title: "Tên chức vụ",
