...
function ChuyenMon({ history, permission, match }) {
  ...
  const deleteItemFunc = (item) => {
    const title = "chuyên môn";
    ModalDeleteConfirm(deleteItemAction, item, item.tenChuyenMon, title);
  };

  const deleteItemAction = (item) => {
    let url = `vptq_lms_ChuyenMon/${item.id}`;
    new Promise((resolve, reject) => {
  ...
  let colValues = [
    ...
    },
    {
      ...
      onFilter: (value, record) => record.maChuyenMon.includes(value),
      filterSearch: true,
    },
    {
