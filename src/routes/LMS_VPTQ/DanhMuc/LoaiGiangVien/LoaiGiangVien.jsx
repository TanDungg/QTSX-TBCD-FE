...
function LoaiGiangVien({ history, permission, match }) {
  ...
  const deleteItemFunc = (item) => {
    ...
    ModalDeleteConfirm(deleteItemAction, item, item.tenLoaiGiangVien, title);
  };

  const deleteItemAction = (item) => {
    let url = `vptq_lms_LoaiGiangVien/${item.id}`;
    new Promise((resolve, reject) => {
  ...
  let colValues = [
    ...
    },
    {
      ...
      filters: removeDuplicates(
        map(dataList, (d) => {
          return {
            text: d.maLoaiGiangVien,
            value: d.maLoaiGiangVien,
          };
        })
      ),
      onFilter: (value, record) => record.maLoaiGiangVien.includes(value),
      filterSearch: true,
    },
    {
