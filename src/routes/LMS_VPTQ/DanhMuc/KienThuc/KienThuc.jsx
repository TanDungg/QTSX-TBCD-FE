...
function KienThuc({ history, permission, match }) {
  ...
  const deleteItemFunc = (item) => {
    const title = "kiến thức";
    ModalDeleteConfirm(deleteItemAction, item, item.tenKienThuc, title);
  };

  const deleteItemAction = (item) => {
    let url = `vptq_lms_KienThuc/${item.id}`;
    new Promise((resolve, reject) => {
  ...
  let colValues = [
    ...
    },
    {
      ...
      onFilter: (value, record) => record.maKienThuc.includes(value),
      filterSearch: true,
    },
    {
      title: "Tên kiến thức",
  ...
  return (
    <div className="gx-main-content">
      <ContainerHeader
        ...
        description="Danh sách kiến thức"
